    ...
    with st.sidebar:
        ...
        custom_css = """
                    ...
                    .stSlider > div > div >  div {                       
                         color: #d83f41 !important; /* 这里设置你想要的颜色 */
                    }
                    .stSlider > div > div > div > div {
                        background-color: #d83f41 !important; /* 这里设置你想要的颜色 */
		   ...
		   .stButton button {
		    background-color: #d83f41 !important; /* 这里设置你想要的颜色 */
		    color: #ffffff !important; /* 这里设置你想要的文本颜色 */
		    border-color: #d83f41 !important; /* 这里设置你想要的边框颜色 */
		    }
		    </style>
                    """
